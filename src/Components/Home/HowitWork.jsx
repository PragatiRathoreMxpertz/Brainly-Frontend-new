                ...
                <div className="max-md:max-w-full">
                    <div className="flex gap-5 max-md:flex-col max-md:gap-0">
                        <div className="flex flex-col w-[24%] max-md:ml-0 max-md:w-full justify-center items-center sm:items-left rounded-[50%]">
                            <div>
                                <img loading="lazy" src={image} alt={title} className="shrink-0 max-w-full aspect-[1.02] w-[127px] max-md:mt-0" style={{ borderRadius: "50%" }} />
                        ...
                        <div className="flex flex-col  w-[76%] max-md:ml-0 max-md:w-full">
                            <div className="flex flex-col grow font-medium tracking-normal max-md:mt-4 text-center sm:text-left  items-center sm:items-left items-baseline">
                                <h3 style={{ marginTop: '0 !important' }} className="text-center font-poppins font-bold sm:text-left w-[100%] text-3xl mt-0 test-shadow font-bold bg-clip-text bg-[linear-gradient(93deg,#761DE8_-2.94%,#29BDEC_56.14%)]">{title}</h3>
                                <p className="mt-1.5 text-lg text-white text-center sm:text-left w-[100%] font-poppins">{subtitle}</p>
                                <p className="mt-0 text-xs sm:mt-2 font-poppins text-[#DCDCDC] pr-2 pb-2">{description}</p>
                            </div>
                        </div>
                    </div>
                </div>
